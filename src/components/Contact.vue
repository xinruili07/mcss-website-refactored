  ...
  <div class="members">
    <div class="intro-container-1">
      ...
      <div style=" margin-left: auto; margin-right: auto; display: block; text-align: center; margin-top: 3vw;">
        ...
        <h1 style="text-align: center; font-size: 30px;"><span style="font-size: 20px; color: rgba(0,0,0,.5); font-weight: bold; font-family: IKEABold;">Make sure to follow us on our social medias!</span></h1>
